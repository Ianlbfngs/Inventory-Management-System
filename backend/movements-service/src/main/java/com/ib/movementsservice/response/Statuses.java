...
public class Statuses{
    ...
    public enum CreateMovementStatus implements IStatus {SUCCESS,SAME_STOCK,INVALID_STOCK_AMOUNT,NOT_ENOUGH_STOCK,TARGET_STOCK_NOT_FOUND,ORIGIN_STOCK_NOT_FOUND,ERROR_UPDATING_STOCK,ORIGIN_AND_TARGET_DIFFERENT_BATCH}
