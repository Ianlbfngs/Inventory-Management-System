...
public class Statuses{
    ...
    public enum CreateProductStatus implements IStatus {SUCCESS,SKU_IN_USE}
    public enum UpdateProductStatus implements IStatus{SUCCESS,SOFT_DELETED,NOT_FOUND,SKU_IN_USE}
